...
const Counter = () => {
  return (
    ...
    <div className='max-width w-full flex max-md:flex-col'>
<div className='w-1/2 ' >
<p className="text-sm font-bold  text-white uppercase pl-2 pb-3">
        business
          </p>
          <h2 className="text-white text-5xl  max-md:text-4xl font-semibold pb-10">
...
<div className='w-1/2 flex max-md:flex-col flex-wrap justify-evenly'>
