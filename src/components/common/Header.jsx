...
{/* navlinks */}
        <div className="flex justify-between items-center text-lg py-3  px-6">
          <ul className=" flex gap-8 items-center font-medium">
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Home</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">About Us</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Services</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Projects</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Blog</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Page</a></li>
            <li><a href="#" className="hover:text-blue-700 duration-300 font-semibold">Contact</a></li>
          </ul>
