...
const Hero = () => {
  return (
    <div className="h-[100vh] bg-blue-200 ">
      <div className="w-full max-width h-full lg:flex  items-center ">
        ...
        <div className="h-full max-md:h-1/2 max-md:hidden">
          <img src={hero} alt="Frame"  className="max-md:h-3/4 h-full w-full object-cover "/>
        </div>
      </div>
    </div>
  );
